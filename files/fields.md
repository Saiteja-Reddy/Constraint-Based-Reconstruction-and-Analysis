## Cobra Model Fields List

The following fields are defined in the COBRA toolbox. If the field is present in a model, it should have the properties defined here and should be of the mentioned dimensions. The dimensions refer to **m** (the number of metabolites), **n** (the number of reactions), **g** (the number of genes) and **c** (the number of compartments).
